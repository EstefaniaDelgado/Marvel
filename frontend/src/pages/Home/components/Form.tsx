    ...
    <div className="py-8 mb-8 ">
      <div className="bg-white  rounded-lg p-4 md:px-0 ">
        ...
        <form
          ...
          className="flex relative flex-col md:flex-row-reverse  md:py-10  max-w-[1440px]  mx-auto "
        >
          {/* Right side - Image preview */}
          <div className="h-64 md:absolute md:h-[565px] xl:h-[605px] md:top-1/2 md:-translate-y-1/2  md:w-1/2 rounded-4xl ">
